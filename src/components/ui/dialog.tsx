  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "data-[state=open]:animate-in data-[state=open]:slide-in-from-bottom-4 data-[state=open]:fade-in data-[state=open]:zoom-in-95",
        "data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom-4 data-[state=closed]:fade-out data-[state=closed]:zoom-out-95",
        "sm:rounded-lg",
        className,
      )}
      {...props}
...
const DialogHeader = ({
  ...
  <div
    className={cn("flex flex-col space-y-2 text-left pr-6", className)}
    {...props}
  />
);
